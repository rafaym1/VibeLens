...
_BLOCKED_ROUTES: list[tuple[str, str]] = [
    ...
    ("POST", "/extensions/plugins/import/{agent}"),
    ...
    ("POST", "/extensions/plugins/{name}/agents"),
    ...
    ("DELETE", "/extensions/plugins/{name}/agents/{agent}"),
    # Catalog install
