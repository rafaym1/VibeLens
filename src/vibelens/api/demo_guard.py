...
_BLOCKED_ROUTES: list[tuple[str, str]] = [
    ...
    ("DELETE", "/hooks/{name}"),
    # Import from agent
    ("POST", "/skills/import/{agent}"),
    ("POST", "/commands/import/{agent}"),
    ("POST", "/subagents/import/{agent}"),
    ("POST", "/hooks/import/{agent}"),
    # Sync / unsync to agent platforms
    ("POST", "/skills/{name}/agents"),
    ("POST", "/commands/{name}/agents"),
    ("POST", "/subagents/{name}/agents"),
    ("POST", "/hooks/{name}/agents"),
    ("DELETE", "/skills/{name}/agents/{agent}"),
    ("DELETE", "/commands/{name}/agents/{agent}"),
    ("DELETE", "/subagents/{name}/agents/{agent}"),
    ("DELETE", "/hooks/{name}/agents/{agent}"),
    # Catalog install
    ("POST", "/extensions/{item_id}/install"),
    # LLM config
    ("POST", "/llm/configure"),
    # Shares
    ("POST", "/shares"),
